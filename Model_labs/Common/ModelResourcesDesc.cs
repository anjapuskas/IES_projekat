...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.REGULARINTERVALSCHEDULE_REGTIMEPS);
			notSettablePropertyIds.Add(ModelCode.DAYTYPE_SEASONDAYTYPESCHS);
			notSettablePropertyIds.Add(ModelCode.SEASON_SEASONDAYTYPESCHS);
