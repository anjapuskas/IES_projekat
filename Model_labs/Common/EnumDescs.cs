...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE1MUL, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE1UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE2MUL, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASICINTERVALSCH_VALUE2UNIT, typeof(UnitSymbol));
